          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-body">
                <?php echo '<img src="' . $row->r_pic . '" alt="Asset After" />'; ?>
              </div>
              <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                    ...
                    <td><?php if($row->r_status == "Pending"){ echo '<span class = "badge badge-warning">'.$row->r_status.'</span>'; } else { echo '<span class = "badge badge-success">'.$row->r_status.'</span>';} ?></td>
                  </tr>
                </tbody>
                <?php $cnt = $cnt+1;}?>
