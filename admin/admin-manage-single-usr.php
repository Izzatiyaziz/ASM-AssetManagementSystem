  ...
  if(isset($_POST['update_user']))
    {
            ...
            $u_pwd=$_POST['u_pwd'];
            $query="update db_user set u_name=?, u_address=?, u_contact=?, u_code=?, u_position=?, u_depart=?, u_email=?, u_pwd=? where u_id=?";
            $stmt = $mysqli->prepare($query);
            $rc=$stmt->bind_param('ssssssssi', $u_name,  $u_address, $u_contact, $u_code, $u_position, $u_depart, $u_email, $u_pwd, $u_id);
            $stmt->execute();
                if($stmt)
                {
                    $succ = "User Updated";
        ...
        ?>
          <form method ="POST"> 
            <div class="form-group">
                ...
                <input type="text" value="<?php echo $row->u_name;?>" class="form-control" id="exampleInputEmail1" name="u_name">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" value="<?php echo $row->u_code;?>" id="exampleInputEmail1" name="u_code">
            </div>

            <div class="form-group">
                <label for="exampleInputEmail1">Position</label>
                <input type="text" value="<?php echo $row->u_position;?>" class="form-control" name="u_position">
            </div>

            <div class="form-group">
                <label for="exampleInputEmail1">Department</label>
                <input type="text" value="<?php echo $row->u_depart;?>" class="form-control" name="u_depart">
            </div>
