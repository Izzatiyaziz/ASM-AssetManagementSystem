        ...
        ?>
          <form method ="POST"> 
            ...
            <div class="form-group">
                ...
                <input type="email" readonly placeholder="<?php echo $row->u_keyname;?>" class="form-control" name="u_keyname">
            </div>

            <div class="form-group">
                <label for="exampleInputEmail1">Model</label>
                <input type="email" readonly placeholder="<?php echo $row->u_key_category;?>" class="form-control" name="u_key_category">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="text" readonly placeholder="<?php echo $row->u_year;?>" class="form-control"   name="u_year">
            </div>
            ...
            <button type="submit" name="delete_booking" class="btn btn-danger">Delete Application</button>
          </form>
          <!-- End Form-->
        <?php }?>
        </div>
