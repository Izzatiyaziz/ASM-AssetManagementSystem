  ...
  if(isset($_POST['add_user']))
    {
            ...
            $u_pwd=$_POST['u_pwd'];
            $query="insert into db_user (u_name, u_contact, u_address, u_code, u_position, u_depart, u_email, u_pwd) values(?,?,?,?,?,?,?,?)";
            $stmt = $mysqli->prepare($query);
            $rc=$stmt->bind_param('ssssssss', $u_name, $u_contact, $u_address, $u_code, $u_position, $u_depart, $u_email, $u_pwd);
            $stmt->execute();
                if($stmt)
                {
                    $succ = "User Added";
        ...
        <div class="card-body">
          ...
          <form method ="POST"> 
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="exampleInputEmail1" name="u_position">
            </div>

            <div class="form-group">
                <label for="exampleInputEmail1">Department</label>
                <input type="text" class="form-control" id="exampleInputEmail1" name="u_depart">
            </div>

            <div class="form-group">
                <label for="exampleInputEmail1">Email</label>
                <input type="email" class="form-control" id="exampleInputEmail1" name="u_email">
            </div>
            <div class="form-group">
