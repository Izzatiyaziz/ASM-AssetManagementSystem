  ...
  if(isset($_POST['publish_feedback']))
    {
            ...
            $query="update db_feedback set  f_status=? where f_id=?";
    ...
    <div id="content-wrapper">
      ...
      <?php if(isset($succ)) {?>
        ...
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Noted</li>
        ...
        <div class="card-body">
          ...
          <?php
            $aid=$_GET['f_id'];
            $ret="select * from db_feedback where f_id=?";
        ...
        ?>
            <form method ="POST"> 
                <div class="form-group">
                    ...
                    <input type="text" required readonly class="form-control" value="<?php echo $row->f_name;?>" id="exampleInputEmail1" name="f_name">
                </div>
                ...
                <button type="submit" name="publish_feedback" class="btn btn-success">Submit</button>
            </form>
          <!-- End Form-->
        <?php }?>
        </div>
